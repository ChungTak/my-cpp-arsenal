...
if(DEFINED ENV{TOOLCHAIN_NAME})
    ...
    set( CROSS_COMPILE riscv64-linux-musl- )
endif()
set( ARCH riscv )
...
set( CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -D__MUSL__ -fsigned-char -Wl,-gc-sections -lstdc++ -lm -lpthread" )

set( CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Os" )
set( CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -march=rv64imafdc" )
set( CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -mabi=lp64d" )
set( CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -D__MUSL__ -fsigned-char" )
