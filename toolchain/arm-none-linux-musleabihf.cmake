...
if(DEFINED ENV{TOOLCHAIN_NAME})
    ...
    set( CROSS_COMPILE arm-linux-musleabihf- )
endif()
set( ARCH arm )
...
set( CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -D__MUSL__ -fsigned-char" )
...
set( CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -D__MUSL__ -mfpu=neon-vfpv4 -ffunction-sections -fdata-sections -Wl,-gc-sections -lm -lpthread" )
