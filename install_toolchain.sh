...
install_musl_toolchains() {
    ...
    if [[ ! -f aarch64-linux-musl-cross.tgz ]]; then
        wget -O aarch64-linux-musl-cross.tgz "https://musl.cc/aarch64-linux-musl-cross.tgz"
    fi
    ...
    if [[ ! -f arm-linux-musleabihf-cross.tgz ]]; then
        wget -O arm-linux-musleabihf-cross.tgz "https://musl.cc/arm-linux-musleabihf-cross.tgz"
    fi
    ...
    if [[ ! -f riscv64-linux-musl-cross.tgz ]]; then
        wget -O riscv64-linux-musl-cross.tgz "https://musl.cc/riscv64-linux-musl-cross.tgz"
    fi
